...
export default function DoctorsPage() {
  ...
  return (
    <main className="clinics-page">
      {/* Başlık – klinikler ile aynı yapı */}
      <section className="clinics-header">
        <h1 className="clinics-title">Doktorlar</h1>
      ...
      {/* Liste kartı – klinik kartı ile aynı stil */}
      <section className="clinics-card">
        <div className="clinics-card-header">
          <h2 className="clinics-card-title">Doktor listesi</h2>
        </div>

        <div className="clinics-card-body">
          {doctors.length === 0 ? (
            <div className="clinics-empty">
              <span>Henüz kayıtlı doktor yok.</span>
              <button
                type="button"
                onClick={openCreateForm}
                className="btn-primary"
      ...
      {isFormOpen && (
        <section className="clinics-card clinics-form">
          ...
          <form onSubmit={handleSubmit} className="clinics-form-grid">
            ...
            {/* 6. satır – üyelik durumu + notlar (senin screenshot’taki gibi yan yana) */}
            <div className="form-field">
